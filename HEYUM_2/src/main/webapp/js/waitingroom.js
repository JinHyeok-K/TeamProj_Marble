...
//let webSocket = new WebSocket('ws://localhost:9191/HEYUM/waitingroom/'+loginid +'/' + roomno); // 김규석 집 아이피
let webSocket = new WebSocket('ws://192.168.17.131:8080/HEYUM/waitingroom/'+loginid +'/' + roomno); // 채우석 학원
//let webSocket = new WebSocket('ws://192.168.0.11:8080/HEYUM/waitingroom/'+loginid +'/' + roomno); // 채우석 집
//let webSocket = new WebSocket('ws://chaews.iptime.org/HEYUM/waitingroom/'+loginid +'/' + roomno); // 채우석 집
//let webSocket = new WebSocket('ws://192.168.17.128:6161/HEYUM/waitingroom/'+loginid +'/' + roomno); // 김규석 학원
let inroomno = roomno ;
let bangjang = 0 ;
let ready = 0 ;
let myready = 0 ;
