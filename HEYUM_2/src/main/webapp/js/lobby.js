...
//let webSocket = new WebSocket('ws://localhost:9191/HEYUM/lobby/'+loginid); // 김규석 집 아이피
//let webSocket = new WebSocket('ws://192.168.0.11:8080/HEYUM/lobby/'+loginid); // 채우석 집
//let webSocket = new WebSocket('ws://chaews.iptime.org/HEYUM/lobby/'+loginid); // 채우석 서버
let webSocket = new WebSocket('ws://192.168.17.131:8080/HEYUM/lobby/'+loginid); // 채우석 학원
//let webSocket = new WebSocket('ws://192.168.17.128:6161/HEYUM/lobby/'+loginid); // 김규석 학원
let inroomno = 0 ;
let bangjang = 0 ;
let receivedmsg = "";
let mypage = 1 ;
