//var webSocket = new WebSocket('ws://192.168.17.85:8080/HEYUM/gamesocket'); // 지웅이 학원
//var webSocket = new WebSocket('ws://192.168.0.7:8080/HEYUM/gamesocket');     // 지웅이 집
//var webSocket = new WebSocket('ws://192.168.0.11:8080/HEYUM/gamesocket'); // 채우석 집
//var webSocket = new WebSocket('ws://chaews.iptime.org/HEYUM/gamesocket'); // 채우석 서버
var webSocket = new WebSocket('ws://192.168.17.131:8080/HEYUM/gamesocket'); // 채우석 학원
//var webSocket = new WebSocket('ws://192.168.17.128:6161/HEYUM/gamesocket'); // 김규석
